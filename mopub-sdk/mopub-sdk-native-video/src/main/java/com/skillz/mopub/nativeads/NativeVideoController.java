...
import com.skillz.mopub.common.VisibilityTracker.VisibilityChecker;
...
public class NativeVideoController extends ExoPlayer.DefaultEventListener implements OnAudioFocusChangeListener {
     ...
     * to full-screen. See
     * {@link com.skillz.mopub.nativeads.MoPubCustomEventVideoNative.MoPubVideoNativeAd#render(MediaLayout)}
     */
