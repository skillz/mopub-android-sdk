...
public class MoPub {
     ...
     * to {@link MoPub.LocationAwareness#TRUNCATED}.
     */
    ...
    public static void disableViewability(@NonNull final ExternalViewabilitySessionManager.ViewabilityVendor vendor) {
