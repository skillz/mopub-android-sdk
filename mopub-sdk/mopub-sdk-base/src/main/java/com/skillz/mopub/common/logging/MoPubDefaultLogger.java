...
public class MoPubDefaultLogger implements MoPubLogger {
     ...
     * "[com.skillz.mopub.common.logging.MoPubLog][log] Ad Custom Log - Loading custom event adapter."
     */
    private static final String MESSAGE_FORMAT = "[%s][%s] %s";

    /**
     * MESSAGE_WITH_ID_FORMAT is used to produce a log in the following format:
     * "[com.skillz.mopub.common.logging.MoPubLog][log][ad-unit-id-123] Adapter Custom Log - Attempting to invoke custom event: com.skillz.mopub.mobileads.HtmlBanner"
     */
