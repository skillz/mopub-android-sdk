...
public class AdTypeTranslator {
    public enum CustomEventType {
        ...
        GOOGLE_PLAY_SERVICES_BANNER("admob_native_banner", "com.skillz.mopub.mobileads.GooglePlayServicesBanner"),
        GOOGLE_PLAY_SERVICES_INTERSTITIAL("admob_full_interstitial", "com.skillz.mopub.mobileads.GooglePlayServicesInterstitial"),
        MILLENNIAL_BANNER("millennial_native_banner", "com.skillz.mopub.mobileads.MillennialBanner"),
        MILLENNIAL_INTERSTITIAL("millennial_full_interstitial", "com.skillz.mopub.mobileads.MillennialInterstitial"),

        // MoPub-specific custom events.
        MRAID_BANNER("mraid_banner", "com.skillz.mopub.mraid.MraidBanner"),
        MRAID_INTERSTITIAL("mraid_interstitial", "com.skillz.mopub.mraid.MraidInterstitial"),
        HTML_BANNER("html_banner", "com.skillz.mopub.mobileads.HtmlBanner"),
        HTML_INTERSTITIAL("html_interstitial", "com.skillz.mopub.mobileads.HtmlInterstitial"),
        VAST_VIDEO_INTERSTITIAL("vast_interstitial", "com.skillz.mopub.mobileads.VastVideoInterstitial"),
        MOPUB_NATIVE("mopub_native", "com.skillz.mopub.nativeads.MoPubCustomEventNative"),
        MOPUB_VIDEO_NATIVE("mopub_video_native", "com.skillz.mopub.nativeads.MoPubCustomEventVideoNative"),
        MOPUB_REWARDED_VIDEO("rewarded_video", "com.skillz.mopub.mobileads.MoPubRewardedVideo"),
