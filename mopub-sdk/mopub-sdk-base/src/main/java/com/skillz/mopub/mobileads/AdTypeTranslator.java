...
public class AdTypeTranslator {
    public enum CustomEventType {
        ...
        MRAID_BANNER("mraid_banner",
                "com.skillz.mopub.mraid.MraidBanner", true),
        MRAID_INTERSTITIAL("mraid_interstitial",
                "com.skillz.mopub.mraid.MraidInterstitial", true),
        ...
        VAST_VIDEO_INTERSTITIAL_TWO("vast_interstitial_two",
                "com.skillz.mopub.mobileads.VastVideoInterstitialTwo", true),
        MOPUB_NATIVE("mopub_native",
                "com.skillz.mopub.nativeads.MoPubCustomEventNative", true),
        MOPUB_VIDEO_NATIVE("mopub_video_native",
                "com.skillz.mopub.nativeads.MoPubCustomEventVideoNative", true),
        ...
        MOPUB_REWARDED_VIDEO_TWO("rewarded_video_two",
                "com.skillz.mopub.mobileads.MoPubRewardedVideoTwo", true),
