...
class VastIconConfigTwo(
    ...
    val clickTrackingUris: List<VastTrackerTwo>,
    ...
    val viewTrackingUris: List<VastTrackerTwo>
) : Serializable {
    ...
    fun handleImpression(
        ...
        TrackingRequest.makeVastTrackingTwoHttpRequest(
            viewTrackingUris,
            null,
            contentPlayHead,
            assetUri,
