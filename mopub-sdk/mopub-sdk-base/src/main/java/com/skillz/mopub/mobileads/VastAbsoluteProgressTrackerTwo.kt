...
open class VastAbsoluteProgressTrackerTwo(
    @Expose @SerializedName(Constants.VAST_TRACKER_TRACKING_MS) val trackingMilliseconds: Int,
    content: String,
    messageType: MessageType,
    isRepeatable: Boolean)
    : VastTrackerTwo(content, messageType, isRepeatable), Comparable<VastAbsoluteProgressTrackerTwo> {
    ...
    data class Builder(private val content: String,
        ...
        fun build() = VastAbsoluteProgressTrackerTwo(trackingMilliseconds, content, messageType, isRepeatable)
    }
    ...
    override fun compareTo(other: VastAbsoluteProgressTrackerTwo): Int {
