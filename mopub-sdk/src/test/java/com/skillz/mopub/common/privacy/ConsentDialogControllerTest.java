...
import com.skillz.mopub.network.MoPubRequestQueueTest;
...
import static com.skillz.mopub.network.MoPubNetworkError.Reason.BAD_BODY;
...
public class ConsentDialogControllerTest {
    ...
    private String generateTestUrl() {
        return "https://" + Constants.HOST + "/m/gdpr_consent_dialog" +
                ...
                "&bundle=com.skillz.mopub.mobileads.test";
    }
}
