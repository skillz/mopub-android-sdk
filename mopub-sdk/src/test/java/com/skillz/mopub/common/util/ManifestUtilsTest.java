...
public class ManifestUtilsTest {
    ...
    public void checkWebViewSdkActivitiesDeclared_shouldNotIncludeActivityDeclarations() throws Exception {
        ...
        assertLogDoesntInclude(
                "com.skillz.mopub.mobileads.MoPubActivity",
                "com.skillz.mopub.mobileads.MraidActivity",
                "com.skillz.mopub.mobileads.RewardedMraidActivity",
                "com.skillz.mopub.mobileads.MraidVideoPlayerActivity",
                "com.skillz.mopub.common.MoPubBrowser",
                "com.skillz.mopub.common.privacy.ConsentDialogActivity"
        );
    }
    ...
    public void displayWarningForMisconfiguredActivities_withOneMisconfiguredActivity_shouldLogOnlyThatOne() throws Exception {
        ...
        assertLogIncludes("com.skillz.mopub.mobileads.MoPubActivity");
    ...
    private void addInterstitialModule() {
        Class moPubActivityClass = com.skillz.mopub.mobileads.MoPubActivity.class;
        Class mraidActivityClass = com.skillz.mopub.mobileads.MraidActivity.class;
        Class rewardedMraidActivityClass = com.skillz.mopub.mobileads.RewardedMraidActivity.class;
    ...
    private static void addActivityToShadowPackageManager(final Context context, final String activityName) {
        ...
        activityInfo.packageName = "com.skillz.mopub.mobileads.test";
