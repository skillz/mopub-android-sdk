...
import com.skillz.mopub.mobileads.CustomEventRewardedVideo;
...
@Config(sdk = 21)
@PowerMockIgnore({ "org.mockito.*", "org.robolectric.*", "android.*", "org.json.*", "com.skillz.mopub.network.CustomSSLSocketFactory" })
