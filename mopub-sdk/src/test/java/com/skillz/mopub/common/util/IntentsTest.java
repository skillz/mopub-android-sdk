...
public class IntentsTest {
    ...
    public void launchApplicationUrl_withUnresolvableMarketUrl_shouldResolveToPlayStoreURLandOpenActivity() throws Exception {
        ...
        final String marketUrl = "market://details?id=com.skillz.mopub.simpleadsdemo";

        // resolvable Play Store url
        final String playStoreUrl = "https://play.google.com/store/apps/details?id=com.skillz.mopub.simpleadsdemo";
    ...
    public void launchApplicationUrl_withResolvableMarketUrl_shouldOpenPlayStoreActivity() throws Exception {
        ...
        // unresolvable equivalent Play Store url ("https://play.google.com/store/apps/details?id=com.skillz.mopub.simpleadsdemo")
    ...
    public void launchApplicationUrl_withUnresolvableMarketUrl_shouldResolveToAmazonStoreURLandOpenActivity() throws Exception {
        ...
        final String storeUrl = "amzn://apps/android?p=com.skillz.mopub.simpleadsdemo";

        // resolvable Amazon Store url
        final String amazonStoreUrl = "http://www.amazon.com/gp/mas/dl/android?p=com.skillz.mopub.simpleadsdemo";
