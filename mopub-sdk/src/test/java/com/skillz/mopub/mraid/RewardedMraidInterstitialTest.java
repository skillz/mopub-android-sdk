...
import static com.skillz.mopub.common.DataKeys.REWARDED_AD_DURATION_KEY;
import static com.skillz.mopub.common.DataKeys.SHOULD_REWARD_ON_CLICK_KEY;
...
import static com.skillz.mopub.common.IntentActions.ACTION_REWARDED_PLAYABLE_COMPLETE;
...
public class RewardedMraidInterstitialTest extends ResponseBodyInterstitialTest {
    ...
    public void loadInterstitial_shouldConnectListenerToBroadcastReceiver() throws Exception {
        ...
        intent = EventForwardingBroadcastReceiverTest.getIntentForActionAndIdentifier(ACTION_REWARDED_PLAYABLE_COMPLETE,
                broadcastIdentifier);
        ShadowLocalBroadcastManager.getInstance(context).sendBroadcast(intent);
    ...
    public void showInterstitial_shouldStartActivityWithIntent() throws Exception {
        ...
        assertThat(intent.getComponent().getClassName())
                .isEqualTo("RewardedMraidActivity");
