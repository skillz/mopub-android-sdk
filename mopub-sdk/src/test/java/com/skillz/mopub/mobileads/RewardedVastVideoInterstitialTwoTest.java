...
public class RewardedVastVideoInterstitialTwoTest {

    private Context context;
    private RewardedVastVideoInterstitialTwo.RewardedVideoInterstitialListenerTwo mRewardedVideoInterstitialListener;
    private Map<String, Object> localExtras;
    private Map<String, String> serverExtras;
    private RewardedVastVideoInterstitialTwo subject;

    @Mock AdReport mockAdReport;

    @Before
    public void setUp() throws Exception {
        subject = new RewardedVastVideoInterstitialTwo();

        final String expectedResponse = "<VAST>hello</VAST>";

        context = Robolectric.buildActivity(Activity.class).create().get();
        mRewardedVideoInterstitialListener = mock(
                RewardedVastVideoInterstitialTwo.RewardedVideoInterstitialListenerTwo.class);
