...
public class MoPubRewardedVideoTwoTest {

    private Activity activity;
    private MoPubRewardedVideoTwo subject;
    private MoPubRewardedAd.MoPubRewardedAdListener listener;

    @Mock private RewardedVastVideoInterstitialTwo mockRewardedVastVideoInterstitial;
    ...
    public void setup() {
        ...
        subject = new MoPubRewardedVideoTwo();
    }
    ...
    public void loadWithSdkInitialized_withNoAdUnitId_shouldUseDefaultAdNetworkId() throws Exception {
        ...
        assertThat(subject.getAdNetworkId()).isEqualTo(MoPubRewardedVideoTwo.MOPUB_REWARDED_VIDEO_TWO_ID);
    }
    ...
    public void moPubRewardedAdListener_onInterstitialLoaded_withMoPubRewardedVideo_shouldPostExpirationRunnable() {
        listener = subject.createListener(MoPubRewardedVideoTwo.class);
