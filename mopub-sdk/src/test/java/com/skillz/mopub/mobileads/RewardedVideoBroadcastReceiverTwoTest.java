...
public class RewardedVideoBroadcastReceiverTwoTest {
    ...
    public void setUp() throws Exception {
        ...
        subject = new RewardedVideoBroadcastReceiverTwo(mRewardedVideoInterstitialListener,
                broadcastIdentifier);
