...
import static com.skillz.mopub.common.Constants.FOUR_HOURS_MILLIS;
import static com.skillz.mopub.common.util.ResponseHeader.CUSTOM_EVENT_DATA;
import static com.skillz.mopub.mobileads.MoPubErrorCode.ADAPTER_NOT_FOUND;
import static com.skillz.mopub.mobileads.MoPubErrorCode.CANCELLED;
import static com.skillz.mopub.mobileads.MoPubErrorCode.INTERNAL_ERROR;
...
public class MoPubInterstitialTest {
    ...
    public void onCustomEventInterstitialLoaded_withoutLoad_shouldNotNotifyListener() throws Exception {
        ...
        assertThat(latestLogMessage.msg.trim())
                .isEqualTo("[com.skillz.mopub.mobileads.MoPubInterstitial][attemptStateTransition] Ad Log " +
