...
public class MoPubListFragment extends ListFragment implements TrashCanClickListener {
    ...
    private static final MoPubSampleAdUnit.AdType[] adTypes = MoPubSampleAdUnit.AdType.values();
    ...
    void addAdUnitViaDeeplink(@Nullable final Uri deeplinkData) {
        ...
        try {
            ...
            Utils.logToast(getContext(), "Ignoring invalid ad unit: " + adUnitId);
            return;
        }

        final String format = deeplinkData.getQueryParameter(FORMAT_KEY);
        final MoPubSampleAdUnit.AdType adType = MoPubSampleAdUnit.AdType.fromDeeplinkString(format);
        if (adType == null) {
            Utils.logToast(getContext(), "Ignoring invalid ad format: " + format);
            return;
        }
    ...
    MoPubSampleAdUnit addAdUnit(@NonNull final MoPubSampleAdUnit moPubSampleAdUnit) {
        ...
        for (int i = 0; i < mAdapter.getCount(); i++) {
            ...
            if (currentAdUnit != null &&
                ...
                Utils.logToast(getContext(), moPubSampleAdUnit.getAdUnitId() + " replaced.");
                break;
            }
        }
    ...
    public static class AddDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(final Bundle savedInstanceState) {
            AlertDialog dialog = new AlertDialog.Builder(getActivity())
                    ...
                    .setPositiveButton("Save ad unit", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(final DialogInterface dialogInterface, final int i) {
                            ...
                            final MoPubSampleAdUnit.AdType adType = adTypes[adTypeSpinner.getSelectedItemPosition()];
            ...
            for (final MoPubSampleAdUnit.AdType adType : adTypes) {
