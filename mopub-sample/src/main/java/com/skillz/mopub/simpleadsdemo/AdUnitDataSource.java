...
class AdUnitDataSource {
    ...
    List<MoPubSampleAdUnit> getDefaultAdUnits() {
        ...
        adUnitList.add(
                new MoPubSampleAdUnit
                        .Builder(mContext.getString(R.string.ad_unit_id_banner), MoPubSampleAdUnit.AdType.BANNER)
                        .description("MoPub Banner Sample")
                        .build());
        adUnitList.add(
                new MoPubSampleAdUnit
                        .Builder(mContext.getString(R.string.ad_unit_id_mrect), MoPubSampleAdUnit.AdType.MRECT)
                        .description("MoPub Mrect Sample")
                        .build());
        adUnitList.add(
                new MoPubSampleAdUnit
                        .Builder(mContext.getString(R.string.ad_unit_id_leaderboard), MoPubSampleAdUnit.AdType.LEADERBOARD)
                        .description("MoPub Leaderboard Sample")
                        .build());
        adUnitList.add(
                new MoPubSampleAdUnit
                        .Builder(mContext.getString(R.string.ad_unit_id_interstitial), MoPubSampleAdUnit.AdType.INTERSTITIAL)
                        .description("MoPub Interstitial Sample")
                        .build());
        adUnitList.add(
                new MoPubSampleAdUnit
                        .Builder(mContext.getString(R.string.ad_unit_id_rewarded_video),
                        MoPubSampleAdUnit.AdType.REWARDED_VIDEO)
        ...
        adUnitList.add(
                new MoPubSampleAdUnit
                        .Builder(mContext.getString(R.string.ad_unit_id_native), MoPubSampleAdUnit.AdType.LIST_VIEW)
                        .description("MoPub Ad Placer Sample")
                        .build());
        adUnitList.add(
                new MoPubSampleAdUnit
                        .Builder(mContext.getString(R.string.ad_unit_id_native), MoPubSampleAdUnit.AdType.RECYCLER_VIEW)
                        .description("MoPub Recycler View Sample")
                        .build());
        adUnitList.add(
                new MoPubSampleAdUnit
                        .Builder(mContext.getString(R.string.ad_unit_id_native), MoPubSampleAdUnit.AdType.CUSTOM_NATIVE)
    ...
    private MoPubSampleAdUnit cursorToAdConfiguration(final Cursor cursor) {
        ...
        final MoPubSampleAdUnit.AdType adType = MoPubSampleAdUnit.AdType.fromFragmentClassName(cursor.getString(4));
