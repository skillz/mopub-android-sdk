...
test_report=$(./adb shell am instrument -w -r -e package com.skillz.mopub.tests.BaseTesting -e debug false com.skillz.mopub.simpleadsdemo.test/androidx.test.runner.AndroidJUnitRunner)
